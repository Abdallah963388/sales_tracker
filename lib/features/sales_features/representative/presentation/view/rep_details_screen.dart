...
import 'package:sit/features/sales_features/representative/presentation/controller/rep_states.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<RepCubit, RepState>(
      ...
      builder: (context, state) {
        ...
        if (rep == null) {
          return Scaffold(
            body: Center(child: Text(s.thereIsNoData)),
          );
        }
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionCard(
                  ...
                  children: [
                    _item(title: s.name, value: rep.name ?? ''),
                    _item(
                      title: s.phone,
                      value: rep.phone ?? '',
                      icon: Icons.phone,
                        ...
                        return Column(
                          children: visits.map((visit) {
                            return ListTile(
                              ...
                              subtitle: Text(
                                'الموقع: ${visit.client?.region ?? ''}\${s.date}: ${visit.createdAt?.substring(0, 10) ?? ''}',
                              ),
                              trailing: IconButton(
                                icon: const Icon(
  ...
  void _showDeleteDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(S.of(context)!.areYouSureYouWantToDeleteThisRep),
        actions: [
          TextButton(
