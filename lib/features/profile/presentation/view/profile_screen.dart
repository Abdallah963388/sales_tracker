...
import 'package:sales_tracker/core/powered_by_widget.dart';
import 'package:sales_tracker/core/routing/app_routes.dart';
import 'package:sales_tracker/core/services/launch_url.dart';
...
import 'package:sales_tracker/features/profile/data/model/profile_model.dart';
import 'package:sales_tracker/features/profile/presentation/controller/profile_cubit.dart';
import 'package:sales_tracker/features/profile/presentation/controller/profile_states.dart';
        ...
        BlocConsumer<LoginCubit, AuthState>(
          listener: (context, state) {
            if (state is LogoutSuccessState) {
              context.read<MainLayoutCubit>().reset();
